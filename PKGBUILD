...
source=("http://www.kernel.org/pub/linux/kernel/v3.x/linux-${_basekernel}.tar.bz2"
	...
	"${_bfqpath}/0003-block-bfq-add-Early-Queue-Merge-EQM-to-BFQ-v6r1-for-3.9.0.patch"
	#TuxOnIce:
...
md5sums=('2220321a0a14d86200322e51dd5033e2'
	 '8523e8f9b1fa9a085e26c4c782e110ac'
         ...
         '67f670f9724b29b3a9b285063270cb7d'
         ...
         'd25e400ebec3fb4710a1982962b0c774')
...
if [ $UKSM = "y" ] ; then
  ...
  md5sums+=('1907b7b3611d934d138e28528ce660d6')
fi
...
package_kernel-netbook-headers() {
  ...
  rm -rf "${pkgdir}"/usr/src/linux-${_kernver}/arch/{alpha,arc,arm,arm26,avr32,blackfin,cris,frv,h8300,ia64,m32r,m68k,m68knommu,metag,mips,microblaze,mn10300,parisc,powerpc,ppc,s390,sh,sh64,sparc,sparc64,um,v850,xtensa}
}
